...
[ClockHandRotationKit][clockhand-rotation-kit]은 Xcode 26.0.1까지 정상적으로 동작했습니다.

문제는 iOS 26.1부터 나타났습니다.
Xcode 26.1의 iOS SDK로 링크한 서드파티 위젯도 정상적으로 빌드됐습니다.
하지만 iOS 26.1 이상에서 실행하면 회전 효과가 적용되지 않았습니다.
